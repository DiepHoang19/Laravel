    ...
    <div class="nk-block-head">
        <div class="nk-block-head-between flex-wrap gap g-2">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title">Posts</h1>
                    <nav>
            ...
            <div class="nk-block-head-content">
                <ul class="d-flex">
                    <li><a href="{{ route('post.create') }}" class="btn btn-primary d-none d-md-inline-flex"><em
                                class="icon ni ni-plus"></em><span>Add Posts</span></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <table class="datatable-init table" data-nk-container="table-responsive">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="tb-col"><span class="overline-title">thumbnail</span></th>
                        <th class="tb-col"><span class="overline-title">content</span></th>
                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td class="tb-col tb-col-md"><span>{{ $post->content }}</span></td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                        <div class="dropdown-content py-1">
                                            <ul class="link-list link-list-hover-bg-primary link-list-md">
                                                <li><a href="{{route('post.edit',['id' => $post->id])}}"><em class="icon ni ni-edit"></em><span>Edit</span></a>
                                                </li>
                                                <li><a href="{{ route('post.trash', ['id' => $post->id]) }}"><em

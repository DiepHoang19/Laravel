                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Posts</h1>
                                    <nav>
                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    <li><a href="{{ route('post.index') }}" class="btn btn-primary btn-md d-md-none"><em
                                                class="icon ni ni-eye"></em><span>View</span></a></li>
                                    <li><a href="{{ route('post.index') }}"
                                            class="btn btn-primary d-none d-md-inline-flex"><em
                                                class="icon ni ni-eye"></em><span>View Posts</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                            ...
                                                            <div class="form-group"><label for="productname"
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control"
                                                                        id="productname" placeholder="Title" name="title">
                                                                    @error('title')
                                                    ...
                                                    <div class="form-group"><label class="form-label">Thumbnail</label>
                                                        <div class="form-control-wrap">
                                                            <div
                                                                ...
                                                                <div class="media media-huge border"><img id="image-result"
                                                                        class="w-100 h-100"

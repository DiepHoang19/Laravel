                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="{{ asset('client/assets/imgs/theme/flag-fr.png') }}"
                                                alt="">Français</a></li>
                                    <li><a href="#"><img src="{{ asset('client/assets/imgs/theme/flag-dt.png') }}"
                                                alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="{{ asset('client/assets/imgs/theme/flag-ru.png') }}"
                                                alt="">Pусский</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            ...
                            <div class="more_slide_open" style="display: none;">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li><a href="shop-grid-right.html"> <img
                                                    src="{{ asset('client/assets/imgs/theme/icons/icon-1.svg') }}"
                                                    alt="">Milks and
                                                Dairies</a></li>
                                        <li><a href="shop-grid-right.html"> <img
                                                    src="{{ asset('client/assets/imgs/theme/icons/icon-2.svg') }}"
                                                    alt="">Clothing &
                                                beauty</a></li>
                                    </ul>
                                    <ul class="end">
                                        <li><a href="shop-grid-right.html"> <img
                                                    src="{{ asset('client/assets/imgs/theme/icons/icon-3.svg') }}"
                                                    alt="">Wines &
                                                Drinks</a></li>
                                        <li><a href="shop-grid-right.html"> <img
                                                    src="{{ asset('client/assets/imgs/theme/icons/icon-4.svg') }}"
                                                    alt="">Fresh
                                                Seafood</a></li>
                                    </ul>
                                </div>
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img
                                                        src="{{ asset('client/assets/imgs/banner/banner-menu.png') }}"
                                                        alt="Nest"></a>
                ...
                <div class="hotline d-none d-lg-flex">
                    <img src="{{ asset('client/assets/imgs/theme/icons/icon-headphone.svg') }}" alt="hotline">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Nest"
                                                    src="{{ asset('client/assets/imgs/shop/thumbnail-4.jpg') }}"></a>
                                        </div>
                                        <div class="shopping-cart-title">

    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="dropdown">
                    <a href="#language"><img src="{{ asset('client/assets/images/flags/eng.png') }}" alt="ENG Flag"
                            width="14" height="8" class="dropdown-image" /> ENG</a>
                    <div class="dropdown-box">
                        <a href="#ENG">
                            <img src="{{ asset('client/assets/images/flags/eng.png') }}" alt="ENG Flag" width="14"
                                height="8" class="dropdown-image" />
                            ENG
                        </a>
                        <a href="#FRA">
                            <img src="{{ asset('client/assets/images/flags/fra.png') }}" alt="FRA Flag" width="14"
                                height="8" class="dropdown-image" />
                            FRA
                        </a>
                    </div>
                ...
                <a href="{{ asset('client/assets/ajax/login.html') }}" class="d-lg-show login sign-in"><i
                        class="w-icon-account"></i>Sign
                    In</a>
                <span class="delimiter d-lg-show">/</span>
                <a href="{{ asset('client/assets/ajax/login.html') }}"
        ...
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="demo1.html" class="logo ml-lg-0">
                    <img src="{{ asset('client/assets/images/logo.png') }}" alt="logo" width="144"
                        height="45" />
                </a>
                    ...
                    <div class="dropdown-box">
                        ...
                        <div class="products">
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/cart/product-1.jpg') }}"
                            ...
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/cart/product-2.jpg') }}"

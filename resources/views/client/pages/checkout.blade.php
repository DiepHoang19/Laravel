                ...
                <div class="col-lg-5">
                    ...
                    <div class="payment ml-30">
                        ...
                        <div class="payment-logo d-flex">
                            <img class="mr-15" src="{{ asset('client/assets/imgs/theme/icons/payment-paypal.svg') }}"
                                alt="">
                            <img class="mr-15" src="{{ asset('client/assets/imgs/theme/icons/payment-visa.svg') }}"
                                alt="">
                            <img class="mr-15" src="{{ asset('client/assets/imgs/theme/icons/payment-master.svg') }}"
                                alt="">
                            <img src="{{ asset('client/assets/imgs/theme/icons/payment-zapper.svg') }}" alt="">
                        </div>

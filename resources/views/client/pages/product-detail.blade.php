                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-2.jp') }}"
                                                alt="product image 11">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-1.jp') }}"
                                                alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-3.jp') }}"
                                                alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-4.jp') }}"
                                                alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-5.jp') }}"
                                                alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-6.jp') }}"
                                                alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{ asset('client/assets/imgs/shop/product-16-7.jp') }}"
                                                alt="product image">
                                        </figure>
                                    </div>
                                    <!-- THUMBNAILS -->
                                    <div class="slider-nav-thumbnails">
                                        ...
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-4.jpg') }}"
                                                alt="product
                                                image"></div>
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-5.jpg') }}"
                                                alt="product
                                                image"></div>
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-6.jpg') }}"
                                                alt="product
                                                image"></div>
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-7.jpg') }}"
                                                alt="product
                                                image"></div>
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-8.jpg') }}"
                                                alt="product
                                                image"></div>
                                        <div><img src="{{ asset('client/assets/imgs/shop/thumbnail-9.jpg') }}"
                                                alt="product
                                                image"></div>
                                    </div>
                                </div>
                                                ...
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-2-1.jp') }}"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-2-2.jp') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-3-1.jp') }}"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-4-2.jp') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-4-1.jp') }}"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-4-2.jp') }}"
                                                            alt="">
                                        ...
                                        <div class="product-cart-wrap hover-up mb-0">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-5-1.jp') }}"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('client/assets/imgs/shop/product-3-2.jp') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">

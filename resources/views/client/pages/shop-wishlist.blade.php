                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img
                                            src="{{ asset('client/assets/imgs/shop/product-2-1.jpg') }}" alt="#">
                                    </td>
                                    <td class="product-des product-name">
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img
                                            src="{{ asset('client/assets/imgs/shop/product-3-1.jpg') }}" alt="#">
                                    </td>
                                    <td class="product-des product-name">
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img
                                            src="{{ asset('client/assets/imgs/shop/product-4-1.jpg') }}" alt="#">
                                    </td>
                                    <td class="product-des product-name">
                                    ...
                                    <td class="text-center detail-info" data-title="Stock">
                                        <span class="stock-status out-stock mb-0">
                                            Out Stock
                                        </span>
                                    </td>
                                    <td class="text-right" data-title="Cart">
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img
                                            src="{{ asset('client/assets/imgs/shop/product-5-1.jpg') }}" alt="#">
                                    </td>
                                    <td class="product-des product-name">

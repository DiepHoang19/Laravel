    ...
    <main class="main">
        <section class="intro-section">
            <div class="swiper-container swiper-theme nav-inner pg-inner swiper-nav-lg animation-slider pg-xxl-hide nav-xxl-show nav-hide"
                data-swiper-options="{'slidesPerView': 1, 'autoplay': {'delay': 8000, 'disableOnInteraction':}}">
                <div class="swiper-wrapper">
                    <div class="swiper-slide banner banner-fixed intro-slide intro-slide1"
                        style="background-image: url({{ asset('client/assets/images/demos/demo1/sliders/slide-1.jpg') }}); background-color: #ebeef2;">
                        <div class="container">
                            <figure class="slide-image skrollable slide-animate">
                                <img src="{{ asset('client/assets/images/demos/demo1/sliders/shoes.png"') }} alt="Banner"
                    ...
                    {{-- <div class="swiper-slide banner banner-fixed intro-slide intro-slide2"
                        style="background-image: url({{ asset('client/assets/images/demos/demo1/sliders/slide-2.jpg') }}); background-color: #ebeef2;">
                        <div class="container">
                            <figure class="slide-image skrollable slide-animate"
                                data-animation-options="{
                            'name': 'fadeInUpShorter',
                            'duration': '1s'}">
                                <img src="{{ asset('client/assets/images/demos/demo1/sliders/men.png"') }} alt="Banner"
                    ...
                    {{-- <div class="swiper-slide banner banner-fixed intro-slide intro-slide3"
                        style="background-image: url({{ asset('client/assets/images/demos/demo1/sliders/slide-3.jpg') }}); background-color: #f0f1f2;">
                        <div class="container">
                            <figure class="slide-image skrollable slide-animate"
                                data-animation-options="{
                            'name': 'fadeInDownShorter',
                            'duration': '1s'}">
                                <img src="{{ asset('client/assets/images/demos/demo1/sliders/skate.png"') }} alt="Banner"
                                    data-bottom-top="transform: translateY(10vh);"
            ...
            <div class="row category-banner-wrapper appear-animate pt-6 pb-8">
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed br-xs">
                        <figure>
                            <img src="{{ asset('client/assets/images/demos/demo1/categories/1-1.jpg') }}"
                ...
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed br-xs">
                        <figure>
                            <img src="{{ asset('client/assets/images/demos/demo1/categories/1-2.jpg') }}"
                                alt="Category Banner" width="610" height="160"
                                        ...
                                        <div class="product product-single row">
                                                        ...
                                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/1-1-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/1-1-800x900') }}.jpg"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/1-2-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/1-2-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/1-3-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/1-3-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/1-4-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/1-4-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="product-details scrollable">
                                                    <h2 class="product-title mb-1"><a href="product-default.html">Coat
                                                            Pool
                                                            Comfort Jacket</a></h2>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/2-1-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/2-1-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/2-2-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/2-2-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/2-3-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/2-3-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('client/assets/images/demos/demo1/products/2-4-600x675') }}.jpg"
                                                                        data-zoom-image="{{ asset('client/assets/images/demos/demo1/products/2-4-800x900') }}.jpg"
                                                                        alt="Product Image" width="800"
                                                                        height="900">
                                                                </figure>
                                                            </div>
                                    ...
                                    <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-1.jpg') }}"
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-2.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-3.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-4.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-5.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-6.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-7.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-8.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="product-default.html">
                                                        <img src="{{ asset('client/assets/images/demos/demo1/products/2-9.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                        ...
                        <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-1.jpg') }}"
                            ...
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-2.jpg') }}"
                                        alt="Category" width="130" height="130">
                                </a>
                                <div class="category-content">
                            ...
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-3.jpg') }}"
                                        alt="Category" width="130" height="130">
                                </a>
                                <div class="category-content">
                            ...
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-4.jpg') }}"
                                        alt="Category" width="130" height="130">
                                </a>
                                <div class="category-content">
                            ...
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-5.jpg') }}"
                                        alt="Category" width="130" height="130">
                                </a>
                                <div class="category-content">
                            ...
                            <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                <a href="shop-banner-sidebar.html" class="category-media">
                                    <img src="{{ asset('client/assets/images/demos/demo1/categories/2-6.jpg') }}"
                                        alt="Category" width="130" height="130">
                                </a>
                                <div class="category-content">
        ...
        <div class="container">
                    ...
                    <div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-1-1') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-1-2') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                    </a>
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-2.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-3.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-4-1') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-4-2') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-5.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-6-1') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-6-2') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-7.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-8-1') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-8-2') }}.jpg"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-9.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/products/3-10.jpg') }}"
                                            alt="Product" width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="row category-cosmetic-lifestyle appear-animate mb-5">
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed category-banner-1 br-xs">
                        <figure>
                            <img src="{{ asset('client/assets/images/demos/demo1/categories/3-1.jpg') }}"
                ...
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed category-banner-2 br-xs">
                        <figure>
                            <img src="{{ asset('client/assets/images/demos/demo1/categories/3-2.jpg') }}"
                                alt="Category Banner" width="610" height="200"
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ asset('client/assets/images/demos/demo1/banners/2.jpg);') }} 
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-1.jpg') }}"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-5-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-5-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-2-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-2-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-6.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-3.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-7.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-4-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-4-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/4-8.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="product-wrapper-1 appear-animate mb-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ asset('client/assets/images/demos/demo1/banners/3.jpg);') }} 
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-1-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-1-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-5.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-2-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-2-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-6.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-3.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-7.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-4.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/5-8.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="banner banner-fashion appear-animate br-sm mb-9"
                style="background-image: url({{ asset('client/assets/images/demos/demo1/banners/4.jpg);') }}
            ...
            <div class="product-wrapper-1 appear-animate mb-7">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ asset('client/assets/images/demos/demo1/banners/5.jpg);') }} 
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-1.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-5.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-2-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-2-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-6.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-3-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-3-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-7.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-4.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-8-1') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('client/assets/images/demos/demo1/products/6-8-2') }}.jpg"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                ...
                <div class="swiper-wrapper row gutter-no cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/1.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/2.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/3.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/4.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/5.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/6.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/7.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/8.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/9.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/10.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                    <div class="swiper-slide brand-col">
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/11.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                        <figure class="brand-wrapper">
                            <img src="{{ asset('client/assets/images/demos/demo1/brands/12.png"') }} alt="Brand"
                                width="410" height="186" />
                        </figure>
                    </div>
                </div>
                    ...
                    'breakpoints': {
                        ...
                        <div class="swiper-wrapper row cols-lg-4 cols-md-3 cols-sm-2 cols-1">
                            <div class="swiper-slide post text-center overlay-zoom">
                                <figure class="post-media br-sm">
                                    <a href="post-single.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/blogs/1.jpg"') }} alt="Post"
                            ...
                            <div class="swiper-slide post text-center overlay-zoom">
                                <figure class="post-media br-sm">
                                    <a href="post-single.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/blogs/2.jpg"') }} alt="Post"
                            ...
                            <div class="swiper-slide post text-center overlay-zoom">
                                <figure class="post-media br-sm">
                                    <a href="post-single.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/blogs/3.jpg"') }} alt="Post"
                            ...
                            <div class="swiper-slide post text-center overlay-zoom">
                                <figure class="post-media br-sm">
                                    <a href="post-single.html">
                                        <img src="{{ asset('client/assets/images/demos/demo1/blogs/4.jpg"') }} alt="Post"
                ...
                <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-1.jpg') }}"
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-2.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-3.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-4.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-5.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-6.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-7.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
                    ...
                    <div class="swiper-slide product-wrap mb-0">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{ asset('client/assets/images/demos/demo1/products/7-8.jpg') }}"
                                        alt="Category image" width="130" height="146"
                                        style="background-color: #fff" />
                                </a>
                            </figure>
